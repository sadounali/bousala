                  ...
                  <div className="p-6 rounded-3xl border-2 border-dashed border-slate-200 bg-slate-50/50 flex flex-col items-center justify-center text-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400">
                        {i18n.language === 'ar'
                          ? 'هذه الميزة قادمة قريباً — ستتمكن من فحص مذكرتك بحثاً عن الانتحال مباشرةً من بوصلة.'
                          : 'This feature is coming soon — you will be able to check your thesis for plagiarism directly from Compass.'}
                      </p>
                    </div>
