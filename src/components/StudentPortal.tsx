...
import { ChevronLeft, Save, GraduationCap, BookOpen, User, Phone, Mail, Hash, MapPin, School, Info, RefreshCcw, CreditCard, ShieldCheck, Share2 } from 'lucide-react';
...
const StudentPortal: React.FC<StudentPortalProps> = ({ onBack, user, onLogin }) => {
  ...
  const [activeTab, setActiveTab] = useState<'pedagogical' | 'memo' | 'subscription'>(
