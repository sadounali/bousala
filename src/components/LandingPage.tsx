...
const SDG_GOALS = [
  { num: 1,  label: 'القضاء على الفقر',        color: '#E5243B', icon: '🏠', desc: 'إنهاء الفقر بجميع أشكاله في كل مكان. يهدف هذا الهدف إلى ضمان حصول جميع الناس على الموارد الاقتصادية والخدمات الأساسية والحماية الاجتماعية.' },
  { num: 2,  label: 'القضاء على الجوع',         color: '#DDA63A', icon: '🌾', desc: 'إنهاء الجوع وتحقيق الأمن الغذائي وتحسين التغذية وتعزيز الزراعة المستدامة لضمان حصول الجميع على غذاء كافٍ وآمن ومغذٍّ.' },
  { num: 3,  label: 'الصحة الجيدة',            color: '#4C9F38', icon: '🏥', desc: 'ضمان تمتع الجميع بأنماط عيش صحية وتعزيز رفاهيتهم في جميع الأعمار، بما يشمل الصحة الإنجابية ومكافحة الأمراض وتعزيز الصحة النفسية.' },
  { num: 4,  label: 'التعليم الجيد',            color: '#C5192D', icon: '📚', desc: 'ضمان التعليم الجيد المنصف والشامل للجميع وتعزيز فرص التعلم مدى الحياة، بما يشمل التعليم الأساسي والتقني والمهني والعالي.' },
  { num: 5,  label: 'المساواة بين الجنسين',     color: '#FF3A21', icon: '⚖️', desc: 'تحقيق المساواة بين الجنسين وتمكين جميع النساء والفتيات من خلال إنهاء جميع أشكال التمييز والعنف وضمان المشاركة الكاملة في الحياة العامة.' },
  { num: 6,  label: 'المياه النظيفة',           color: '#26BDE2', icon: '💧', desc: 'ضمان توافر المياه وخدمات الصرف الصحي للجميع وإدارتها على نحو مستدام، بما يشمل الحصول على مياه الشرب المأمونة والنظافة الصحية.' },
  { num: 7,  label: 'الطاقة النظيفة',           color: '#FCC30B', icon: '⚡', desc: 'ضمان حصول الجميع على طاقة حديثة وموثوقة ومستدامة وبأسعار معقولة، مع زيادة حصة الطاقة المتجددة وتحسين كفاءة استخدام الطاقة.' },
  { num: 8,  label: 'العمل اللائق',             color: '#A21942', icon: '💼', desc: 'تعزيز النمو الاقتصادي المطرد والشامل والمستدام، وتوفير العمل اللائق للجميع، والقضاء على العمل القسري وعمالة الأطفال.' },
  { num: 9,  label: 'الصناعة والابتكار',        color: '#FD6925', icon: '🏭', desc: 'بناء بنية تحتية قادرة على الصمود وتعزيز التصنيع الشامل والمستدام وتشجيع الابتكار، مع دعم البحث العلمي والتطور التكنولوجي.' },
  { num: 10, label: 'الحد من التفاوت',          color: '#DD1367', icon: '🤝', desc: 'الحد من التفاوت داخل البلدان وفيما بينها من خلال تعزيز الشمول الاجتماعي والاقتصادي والسياسي لجميع الناس بصرف النظر عن العمر أو الجنس أو الإعاقة.' },
  { num: 11, label: 'المدن المستدامة',          color: '#FD9D24', icon: '🏙️', desc: 'جعل المدن والمستوطنات البشرية شاملة وآمنة وقادرة على الصمود ومستدامة، بما يشمل الإسكان والنقل والمساحات الخضراء وإدارة النفايات.' },
  { num: 12, label: 'الإنتاج المسؤول',          color: '#BF8B2E', icon: '♻️', desc: 'ضمان أنماط الاستهلاك والإنتاج المستدامة، بما يشمل الإدارة المستدامة للموارد الطبيعية وخفض الفاقد الغذائي والحد من النفايات.' },
  { num: 13, label: 'المناخ',                   color: '#3F7E44', icon: '🌍', desc: 'اتخاذ إجراءات عاجلة للتصدي لتغير المناخ وآثاره، بما يشمل تعزيز القدرة على الصمود والتكيف والحد من انبعاثات غازات الاحتباس الحراري.' },
  { num: 14, label: 'الحياة تحت الماء',         color: '#0A97D9', icon: '🐟', desc: 'حفظ المحيطات والبحار والموارد البحرية واستخدامها على نحو مستدام، والحد من تلوث البحار وحماية النظم الإيكولوجية البحرية والساحلية.' },
  { num: 15, label: 'الحياة البرية',            color: '#56C02B', icon: '🌳', desc: 'صون النظم الإيكولوجية البرية وإعادة تأهيلها وتعزيز استخدامها على نحو مستدام، والحد من تدهور الأراضي ووقف فقدان التنوع البيولوجي.' },
  { num: 16, label: 'السلام والعدالة',          color: '#00689D', icon: '🕊️', desc: 'تعزيز مجتمعات مسالمة وشاملة من أجل التنمية المستدامة وتوفير إمكانية الوصول إلى العدالة للجميع وبناء مؤسسات فعالة وخاضعة للمساءلة.' },
  { num: 17, label: 'الشراكات',                 color: '#19486A', icon: '🌐', desc: 'تعزيز وسائل التنفيذ وتنشيط الشراكة العالمية من أجل التنمية المستدامة، بما يشمل التمويل والتكنولوجيا وبناء القدرات والتجارة.' },
];

const NAV_LINKS = [
  { label: 'الرئيسية',   href: '#hero',     modal: null },
  { label: 'المميزات',   href: '#features', modal: null },
  { label: 'عن التطبيق', href: '#sdg',      modal: null },
  { label: 'تواصل معنا', href: null,        modal: 'contact' },
];

const LandingPage: React.FC<LandingPageProps> = ({ onGetStarted }) => {
  const [showTerms, setShowTerms] = useState(false);
  const [showContact, setShowContact] = useState(false);
  const [selectedSdg, setSelectedSdg] = useState<typeof SDG_GOALS[0] | null>(null);
  const [activeLink, setActiveLink] = useState('#hero');
  const [menuOpen, setMenuOpen] = useState(false);

  const handleNavLink = (link: typeof NAV_LINKS[0]) => {
    setMenuOpen(false);
    if (link.modal === 'contact') {
      setShowContact(true);
      return;
    }
    if (link.href) {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col font-sans" dir="rtl">
      {/* ── Navbar ── */}
      <nav className="h-16 bg-white/90 backdrop-blur-md border-b border-slate-100 px-6 flex items-center justify-between sticky top-0 z-50 shadow-sm">
        ...
        <div className="hidden md:flex items-center gap-1">
          {NAV_LINKS.map(link => (
            <button key={link.label} onClick={() => handleNavLink(link)}
              className={`px-4 py-2 rounded-xl text-sm font-bold transition-all ${activeLink === link.href ? 'text-oued-blue bg-oued-blue/10' : 'text-slate-400 hover:text-slate-700 hover:bg-slate-50'}`}>
              {link.label}
            </button>
          ))}
        </div>
        {/* Mobile hamburger */}
        <button className="md:hidden flex flex-col gap-1.5 p-2 rounded-xl hover:bg-slate-50 transition-all"
          onClick={() => setMenuOpen(v => !v)}>
          <span className={`block w-5 h-0.5 bg-slate-500 transition-all duration-300 ${menuOpen ? 'rotate-45 translate-y-2' : ''}`} />
          <span className={`block w-5 h-0.5 bg-slate-500 transition-all duration-300 ${menuOpen ? 'opacity-0' : ''}`} />
          <span className={`block w-5 h-0.5 bg-slate-500 transition-all duration-300 ${menuOpen ? '-rotate-45 -translate-y-2' : ''}`} />
        </button>
      </nav>
      {/* Mobile dropdown */}
      <AnimatePresence>
        {menuOpen && (
          <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }}
            className="md:hidden sticky top-16 z-40 bg-white border-b border-slate-100 shadow-lg px-4 py-3 flex flex-col gap-1">
            {NAV_LINKS.map(link => (
              <button key={link.label} onClick={() => handleNavLink(link)}
                className={`w-full text-right px-4 py-3 rounded-xl text-sm font-bold transition-all ${activeLink === link.href ? 'text-oued-blue bg-oued-blue/10' : 'text-slate-500 hover:text-slate-800 hover:bg-slate-50'}`}>
                {link.label}
              </button>
            ))}
          </motion.div>
      ...
      {/* ── Hero ── */}
      <section id="hero" className="flex flex-col items-center justify-center text-center px-6 py-24 bg-gradient-to-b from-slate-50 to-white relative overflow-hidden">
        ...
        >
          <span className="text-xs font-medium tracking-wide">تمرير للأسفل</span>
          <motion.div
            animate={{ y: [0, 8, 0] }}
      ...
      {/* ── SDG Matrix Section ── */}
      <section id="sdg" className="py-20 px-6 bg-slate-50">
        <div className="max-w-5xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12 space-y-4">
            ...
            <p className="text-xs text-slate-400 font-medium">اضغط على أي هدف لمعرفة تفاصيله ✨</p>
          </motion.div>
          {/* SDG colored squares — clickable */}
          <div className="grid grid-cols-6 sm:grid-cols-9 md:grid-cols-9 gap-2 mb-10 justify-items-center">
            {SDG_GOALS.map((sdg, i) => (
              ...
              >
                <div
                  className="w-12 h-12 rounded-xl flex items-center justify-center text-white font-black text-base shadow-md group-hover:scale-110 group-hover:shadow-lg transition-all"
      ...
      <AnimatePresence>
        {selectedSdg && (
          ...
          >
            ...
            >
              {/* Colored top bar */}
              <div className="absolute top-0 left-0 right-0 h-2 rounded-t-3xl" style={{ backgroundColor: selectedSdg.color }} />
              <button
                onClick={() => setSelectedSdg(null)}
                className="absolute top-5 left-5 text-slate-400 hover:text-slate-900 transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
              {/* SDG header */}
              <div className="flex items-center gap-4 mb-5 mt-2">
                ...
                <div>
                  <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">الهدف {selectedSdg.num}</p>
                  <h2 className="text-xl font-black text-slate-900">{selectedSdg.label}</h2>
                </div>
              </div>
              {/* Emoji icon */}
              <div className="text-4xl mb-4">{selectedSdg.icon}</div>
              {/* Description */}
              <p className="text-sm text-slate-600 leading-relaxed mb-6">{selectedSdg.desc}</p>
              {/* Footer */}
              <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                <span className="text-xs text-slate-400">أهداف التنمية المستدامة · الأمم المتحدة</span>
                <button
                  onClick={() => setSelectedSdg(null)}
                  className="px-5 py-2 rounded-xl text-white text-sm font-bold hover:opacity-90 transition-all"
                  style={{ backgroundColor: selectedSdg.color }}
                >
                  إغلاق
                </button>
