...
export default function Sidebar({ currentView, onViewChange, isOpen, onToggle, isMobile = false }: SidebarProps) {
  ...
  const menuItems = [
    { id: AppView.MAIN, label: t('nav.home'), icon: Home },
    { id: AppView.THESIS, label: t('nav.thesis'), icon: BookOpen },
    { id: AppView.HISTORY, label: t('nav.history'), icon: History },
    { id: AppView.STUDENT_INFO, label: t('nav.profile'), icon: UserCog },
  ];
